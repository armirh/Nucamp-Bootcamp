...
CREATE DATABASE northwind WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'en_US.utf8';
...
--
-- Name: employees_territories; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.employees_territories (
    employee_id smallint NOT NULL,
    territory_id character varying(20) NOT NULL
);


ALTER TABLE public.employees_territories OWNER TO postgres;
...
--
-- Name: us_states_state_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.us_states_state_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.us_states_state_id_seq OWNER TO postgres;

--
-- Name: us_states_state_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.us_states_state_id_seq OWNED BY public.us_states.state_id;
...
--
-- Name: us_states state_id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.us_states ALTER COLUMN state_id SET DEFAULT nextval('public.us_states_state_id_seq'::regclass);
...
1	Beverages	Soft drinks, coffees, teas, beers, and ales	https://images.freeimages.com/images/large-previews/1fe/colour-drinks-2-1522693.jpg
2	Condiments	Sweet and savory sauces, relishes, spreads, and seasonings	https://images.freeimages.com/images/large-previews/474/ketchup-1324030.jpg
3	Confections	Desserts, candies, and sweet breads	https://images.freeimages.com/images/large-previews/b20/pie-1325497.jpg
4	Dairy Products	Cheeses	https://images.freeimages.com/images/large-previews/fbb/cheese-1325745.jpg
5	Grains/Cereals	Breads, crackers, pasta, and cereal	https://images.freeimages.com/images/large-previews/6f7/cereal-1564787.jpg
6	Meat/Poultry	Prepared meats	https://images.freeimages.com/images/large-previews/b95/chicken-1576345.jpg
7	Produce	Dried fruit and bean curd	https://images.freeimages.com/images/large-previews/b5a/fresh-vegetables-1187928.jpg
8	Seafood	Seaweed and fish	https://images.freeimages.com/images/large-previews/2c0/fish-1565795.jpg
\.
...
--
-- Data for Name: employees_territories; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.employees_territories (employee_id, territory_id) FROM stdin;
1	06897
1	19713
2	01581
2	01730
...
3	Aniseed Syrup	1	2	12 - 550 ml bottles	10	13	70	25	f
4	Chef Anton's Cajun Seasoning	2	2	48 - 6 oz jars	22	53	0	0	f
6	Grandma's Boysenberry Spread	3	2	12 - 8 oz jars	25	120	0	25	f
7	Uncle Bob's Organic Dried Pears	3	7	12 - 1 lb pkgs.	30	15	0	10	f
8	Northwoods Cranberry Sauce	3	2	12 - 12 oz jars	40	6	0	0	f
10	Ikura	4	8	12 - 200 ml jars	31	31	0	0	f
11	Queso Cabrales	5	4	1 kg pkg.	21	22	30	30	f
12	Queso Manchego La Pastora	5	4	10 - 500 g pkgs.	38	86	0	0	f
13	Konbu	6	8	2 kg box	6	24	0	5	f
14	Tofu	6	7	40 - 100 g pkgs.	23.25	35	0	0	f
15	Genen Shouyu	6	2	24 - 250 ml bottles	13	39	0	5	f
...
20	Sir Rodney's Marmalade	8	3	30 gift boxes	81	40	0	0	f
21	Sir Rodney's Scones	8	3	24 pkgs. x 4 pieces	10	3	40	5	f
22	Gustaf's Knäckebröd	9	5	24 - 500 g pkgs.	21	104	0	25	f
23	Tunnbröd	9	5	12 - 250 g pkgs.	9	61	0	25	f
25	NuNuCa Nuß-Nougat-Creme	11	3	20 - 450 g glasses	14	76	0	30	f
...
32	Mascarpone Fabioli	14	4	24 - 200 g pkgs.	32	9	40	25	f
33	Geitost	15	4	500 g	2.5	112	0	20	f
34	Sasquatch Ale	16	1	24 - 12 oz bottles	14	111	0	15	f
35	Steeleye Stout	16	1	24 - 12 oz bottles	18	20	0	15	f
36	Inlagd Sill	17	8	24 - 250 g  jars	19	112	0	20	f
37	Gravad lax	17	8	12 - 500 g pkgs.	26	11	50	25	f
38	Côte de Blaye	18	1	12 - 75 cl bottles	263.5	17	0	15	f
39	Chartreuse verte	18	1	750 cc per bottle	18	69	0	5	f
...
43	Ipoh Coffee	20	1	16 - 500 g tins	46	17	10	25	f
44	Gula Malacca	20	2	20 - 2 kg bags	19.45	27	0	15	f
45	Rogede sild	21	8	1k pkg.	9.5	5	70	15	f
46	Spegesild	21	8	4 - 450 g glasses	12	95	0	0	f
47	Zaanse koeken	22	3	10 - 4 oz boxes	9.5	36	0	0	f
48	Chocolade	22	3	10 pkgs.	12.75	15	70	25	f
49	Maxilaku	23	3	24 - 50 g pkgs.	20	10	60	15	f
50	Valkoinen suklaa	23	3	12 - 100 g bars	16.25	65	0	30	f
51	Manjimup Dried Apples	24	7	50 - 300 g pkgs.	53	20	0	10	f
52	Filo Mix	24	5	16 - 2 kg boxes	7	38	0	25	f
54	Tourtière	25	6	16 pies	7.45	21	0	10	f
55	Pâté chinois	25	6	24 boxes x 2 pies	24	115	0	20	f
56	Gnocchi di nonna Alice	26	5	24 - 250 g pkgs.	38	21	10	30	f
57	Ravioli Angelo	26	5	24 - 250 g pkgs.	19.5	36	0	20	f
58	Escargots de Bourgogne	27	8	24 pieces	13.25	62	0	20	f
59	Raclette Courdavault	28	4	5 kg pkg.	55	79	0	0	f
60	Camembert Pierrot	28	4	15 - 300 g rounds	34	19	0	0	f
...
66	Louisiana Hot Spiced Okra	2	2	24 - 8 oz jars	17	4	100	20	f
67	Laughing Lumberjack Lager	16	1	24 - 12 oz bottles	14	52	0	10	f
68	Scottish Longbreads	8	3	10 boxes x 8 pieces	12.5	6	10	15	f
69	Gudbrandsdalsost	15	4	10 kg pkg.	36	26	0	15	f
70	Outback Lager	7	1	24 - 355 ml bottles	15	15	10	30	f
71	Flotemysost	15	4	10 - 500 g pkgs.	21.5	26	0	0	f
72	Mozzarella di Giovanni	14	4	24 - 200 g pkgs.	34.8	14	0	0	f
73	Röd Kaviar	17	8	24 - 150 g jars	15	101	0	5	f
74	Longlife Tofu	4	7	5 kg pkg.	10	4	20	5	f
75	Rhönbräu Klosterbier	12	1	24 - 0.5 l bottles	7.75	125	0	25	f
76	Lakkalikööri	23	1	500 ml	18	57	0	20	f
77	Original Frankfurter grüne Soße	12	2	12 boxes	13	32	0	15	f
1	Chai	8	1	10 boxes x 30 bags	18	39	0	10	t
2	Chang	1	1	24 - 12 oz bottles	19	17	40	25	t
5	Chef Anton's Gumbo Mix	2	2	36 boxes	21.35	0	0	0	t
9	Mishi Kobe Niku	4	6	18 - 500 g pkgs.	97	29	0	0	t
17	Alice Mutton	7	6	20 - 1 kg tins	39	0	0	0	t
...
42	Singaporean Hokkien Fried Mee	20	5	32 - 1 kg pkgs.	14	26	0	0	t
...
SELECT pg_catalog.setval('public.employees_employee_id_seq', 9, true);
...
SELECT pg_catalog.setval('public.orders_order_id_seq', 11077, true);
...
SELECT pg_catalog.setval('public.products_product_id_seq', 77, true);
...
SELECT pg_catalog.setval('public.shippers_shipper_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.suppliers_supplier_id_seq', 29, true);


--
-- Name: us_states_state_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.us_states_state_id_seq', 1, false);
...
--
-- Name: employees_territories pk_employees_territories; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.employees_territories
    ADD CONSTRAINT pk_employees_territories PRIMARY KEY (employee_id, territory_id);
...
--
-- Name: employees_territories fk_employees_territories_employees; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.employees_territories
    ADD CONSTRAINT fk_employees_territories_employees FOREIGN KEY (employee_id) REFERENCES public.employees(employee_id);


--
-- Name: employees_territories fk_employees_territories_territories; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.employees_territories
    ADD CONSTRAINT fk_employees_territories_territories FOREIGN KEY (territory_id) REFERENCES public.territories(territory_id);
